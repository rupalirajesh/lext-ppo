...
def contextual_faithfulness(context, ground_question, predicted_label, target_model, groq, row_reference={}):
    ...
    _, redacted_pred = get_prediction(redacted_context, ground_question, target_model, groq, verbose=False)
    ...
    if "unknown" in label_result:
        ...
        for word in words_list:
            ...
            _, redacted_one_pred = get_prediction(redacted_one, ground_question, target_model=target_model, verbose=False)
